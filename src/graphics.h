 ...
 * @param start_t The starting angle of the arc, in radians
 * @param end_t The ending angle of the arc, in radians
 * @param graphics_color The color to draw in
 */
void graphics_arc(int x, int y, double r, double start_t, double end_t,
